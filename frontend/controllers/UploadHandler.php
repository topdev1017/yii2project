...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/temp/videos/',
            'upload_url' => $this->get_full_url().'/temp/videos/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
...
//            $this->initialize();
    ...
    protected function upcount_name($filename, $uploadDirectory) {
       // return preg_replace_callback(
//            '/(?:(?: \(([\d]+)\))?(\.[^.]+))?$/',
//            array($this, 'upcount_name_callback'),
//            $name,$uploadDirectory, $filename
//            1
//        );
    ...
    protected function get_unique_filename($file_path, $name, $size, $type, $error,
        ...
        while(is_dir($this->get_upload_path($name))) {
            $name = $this->upcount_name($name, $this->get_upload_path());
        }
