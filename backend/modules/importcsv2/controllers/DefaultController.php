...
//    $this->registerJs(Yii::$app->request->baseUrl.'/modules/importcsv/assets/ajaxupload.js', $this::POS_READY);
...
//	 $this->registerJs('uploadActionPath', 'var uploadActionPath="' . $this->createUrl('default/upload') . '"', CClientScript::POS_BEGIN);
//     $this->registerJs(Yii::$app->request->baseUrl.'/modules/importcsv/assets/download.js', $this::POS_READY);
