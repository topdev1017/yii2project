...
<div class="box-header">
  <h3 class="box-title">Manufactures</h3>
</div><!-- /.box-header -->
<?
...
<div class="form-group">
   <label class="control-label col-sm-3">Specialized:</label>
   <div class="col-sm-4">
   <?= Select2::widget([
        'name' => 'columns[category]', 
        'id' => 'columns_cat', 
        'data' => $columns,
        'options' => ['placeholder' => 'Select Column ...', 'multiple'=>true],
        'pluginOptions' => [
            'allowClear' => true,
        ],
    ]); ?>
    <span>Please select multiple columns representing categories</span>
   </div>
 </div>
